Project Description:
This project aims to address the problem of skin cancer classification and develop an optimized machine learning model for accurately classifying different types of skin cancer. The project utilizes image data from the ISIC Challenge and compares it with a collection of 10,015 images representing seven distinct skin cancer types.
